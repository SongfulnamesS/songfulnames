...
function sayaman(IDsayaman) {
 var output = "<embed class=\"player_conte\" src=\"http://narutofox.tv/athena/plugins/iaplayer.swf\" width=\"605\" height=\"340\" allowscriptaccess=\"always\" allowfullscreen=\"true\" wmode=\"opaque\" flashvars=\"file=https://docs.google.com/file/d/" + IDsayaman + "&image=http://2.bp.blogspot.com/-X_Gvjx0n5_o/U68-u_BKQMI/AAAAAAAACZw/QzQ1FsluS8s/s1600/LOGO.png&amp;provider=video&amp;stretching=exactfit&amp;controlbar.position=over&amp;skin=http://rineanime.tv/gk/skin/rineanime.zip&amp;logo.file=http://1.bp.blogspot.com/-mPAQ7kykKj0/U1FjhNTfpkI/AAAAAAAACC8/gVULCYIde9s/s1600/logoeskina.png&amp;logo.position=top-right&amp;logo.link=http://songfulme.blogspot.com/&amp;logo.hide=false&amp;logo.timeout=5&amp;logo.out=0.4&amp;abouttext=Songful AnimeID anime de calidad&amp;aboutlink=#&amp;plugins=backstroke-1,timeslidertooltipplugin-1\">";
 output += "</embed>";
 document.write (output);
}

function google(IDgoogle) {
 var output = "<embed class=\"player_conte\" src=\"http://rineanime.tv/gk/docsgoogle/player.swf\" width=\"605\" height=\"340\" allowscriptaccess=\"always\" allowfullscreen=\"true\" wmode=\"opaque\" flashvars=\"file=https://docs.google.com/file/d/" + IDgoogle + "&image=http://2.bp.blogspot.com/-X_Gvjx0n5_o/U68-u_BKQMI/AAAAAAAACZw/QzQ1FsluS8s/s1600/LOGO.png&amp;provider=video&amp;stretching=exactfit&amp;controlbar.position=over&amp;skin=http://rineanime.tv/gk/skin/rineanime.zip&amp;logo.file=http://1.bp.blogspot.com/-mPAQ7kykKj0/U1FjhNTfpkI/AAAAAAAACC8/gVULCYIde9s/s1600/logoeskina.png&amp;logo.position=top-right&amp;logo.link=http://songfulme.blogspot.com/&amp;logo.hide=false&amp;logo.timeout=5&amp;logo.out=0.4&amp;abouttext=Songful AnimeID anime de calidad&amp;aboutlink=#&amp;plugins=backstroke-1,timeslidertooltipplugin-1\">";
 output += "</embed>";
 document.write (output);
}

function googlecito(IDgooglecito) {
 var output = "<embed class=\"player_conte\" src=\"http://rineanime.tv/gk/plus/player.swf\" width=\"605\" height=\"340\" allowscriptaccess=\"always\" allowfullscreen=\"true\" wmode=\"opaque\" flashvars=\"file=https://plus.google.com/photos/" + IDgooglecito + "&image=http://2.bp.blogspot.com/-X_Gvjx0n5_o/U68-u_BKQMI/AAAAAAAACZw/QzQ1FsluS8s/s1600/LOGO.png&amp;provider=video&amp;stretching=exactfit&amp;controlbar.position=over&amp;skin=http://rineanime.tv/gk/skin/riskin.zip&amp;logo.file=http://1.bp.blogspot.com/-mPAQ7kykKj0/U1FjhNTfpkI/AAAAAAAACC8/gVULCYIde9s/s1600/logoeskina.png&amp;logo.position=top-right&amp;logo.link=http://songfulme.blogspot.com/&amp;logo.hide=false&amp;logo.timeout=5&amp;logo.out=0.4&amp;abouttext=Songful AnimeID anime de calidad&amp;aboutlink=#&amp;plugins=backstroke-1,timeslidertooltipplugin-1\">";
 output += "</embed>";
 document.write (output);
}
...
function gamovideo(IDgamovideo) {
  var output = "<iframe src=\"http://gamovideo.com/embed-" + IDgamovideo + "-605x340.html\" frameborder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"605\" height=\"340\">";
  output += "</iframe>";
  document.write (output);
}
...
function vidspot(IDvidspot) {
  var output = "<iframe src=\"http://vidspot.net/embed-" + IDvidspot + ".html\"frameborder=0 marginwidth=0 marginheight=0 scrolling=NO allowfullscreen='true' width=605 height=340>";
  output += "</iframe>";
  document.write (output);
}

function viki(IDviki) {
  var output = "<iframe src=\"http://zet.videosxd.org/repro-d/viki?v=" + IDviki + "\" width=\"605\" height=\"340\" frameborder=\"0\" scrolling=\"no\" scanned=\"yes\">";
  output += "</iframe>";
  document.write (output);
}
...
function videodwn(IDvideodwn) {
  var output = "<iframe src=\"http://dwn.so/player/embed.php?v=" + IDvideodwn + "&width=605&height=340\"width=\"605\"height=\"340\"frameborder=\"0\"scrolling=\"no\">";
  output += "</iframe>";
  document.write (output);
}

function xvideos(IDxvideos) {
  var output = "<iframe src=\"http://flashservice.xvideos.com/embedframe/" + IDxvideos + "\"frameborder=0 width=605 height=340 scrolling=no>";
  output += "</iframe>";
  document.write (output);
}

function netu(IDnetu) {
  var output = "<iframe src=\"http://hqq.tv/player/embed_player.php?vid=" + IDnetu + "&autoplay=no\" height=\"340\" width=\"605\" style=\"z-index:2147483647;\" webkitAllowFullScreen mozallowfullscreen allowfullscreen frameborder=\"0\" scrolling=\"no\">";
  output += "</iframe>";
  document.write (output);
}
...
function allmyvideos(IDallmyvideos) {
  var output = "<iframe src=\"http://allmyvideos.net/embed-" + IDallmyvideos + "-605x340.html\"frameborder=\"0\"marginwidth=\"0\"marginheight=\"0\"scrolling=\"NO\"width=\"605\"height=\"340\">";
  output += "</iframe>";
  document.write (output);
}
...
function ochenta(IDochenta) {
  var output = "<IFRAME SRC=\"http://180upload.com/embed-" + IDochenta + "-605x340.html\"FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=605 HEIGHT=340>";
  output += "</IFRAME>";
  document.write (output);
}

function vidbull(IDvidbull) {
  var output = "<iframe src=\"http://vidbull.com/embed-" + IDvidbull + "-605x340.html\"frameborder=\"0\"marginwidth=\"0\"marginheight=\"0\"scrolling=\"NO\"width=\"605\"height=\"340\">";
  output += "</iframe>";
  document.write (output);
}
...
function vidxden(IDvidxden) {
  var output = "<iframe title=\"vidxden video player\"width=\"605\"height=\"340\"src=\"http://www.vidxden.com/" + IDvidxden + "&amp; width=530&amp; height=340\"frameborder=\"0\"allowfullscreen>";
  output += "</iframe>";
  document.write (output);
}
...
function vidbux(IDvidbux) {
  var output = "<IFRAME SRC=\"http://www.vidbux.com/embed-" + IDvidbux + "-width-530-height-340.html\"FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=530 HEIGHT=340>";
  output += "</IFRAME>";
  document.write (output);
}
