...
function picasas(IDpicasas) {
 var output = "<iframe style=\"overflow: hidden; border: 0; width: 565px; height: 318px\" class=\"player_conte\" src=\"http://www.vanime.net/plugins/gkplugins_picasaweb/index2.php?url=https://picasaweb.google.com/lh/photo/" + IDpicasas + "&amp;width=565&amp;height=318&amp;tiempo=10\" scrolling=\"no\">";
 output += "</iframe>";
 document.write (output);
}
