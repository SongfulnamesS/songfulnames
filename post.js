(function() {
    ...
    FFBS_show_share_7yz2 = true;
    FFBS_enable_ads_7yz2 = true;
    FFBS_info_7yz2 = "info";
    FFBS_share_7yz2 = "share_7yz2";
    ...
    if (maxStars > 2) {
        ...
        if (FFBS_data_7yz2['label-rating'] == "") {
            avgStr = "rating: " + Math.round(0.00 * 10) / 10;
        } else {
            avgStr = FFBS_data_7yz2['label-rating'] + Math.round(0.00 * 10) / 10;
        }
        ...
        if ("stats_7yz2" == "rate_7yz2") {
            tmp += stats;
        } else if ("stats_7yz2" != "") {
            var statsDiv = document.getElementById("stats_7yz2");
            if (statsDiv != null) {
