...
function capanime(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<li><a class="cuerpo-der" title="'+ posttitle +'" href="' + posturl + '"><img src="' + img[i] + '" width="47" height="47" border="0" alt="' + posttitle + '"/></a><a class="titulo-rec" href="' + posturl + '">' + posttitle + '</a><div class="rated_star"><span>'+daystr+'</span><img src="http://i.imgur.com/GWOKAA9.png" style="height:11px; vertical-align:middle;" title="Progamacion Doramas" alt="Progamacion Doramas"></div><a class="ver-anime" href=' + posturl + '><img style="vertical-align:middle;" src="http://i.imgur.com/VBwAaDQ.png" alt="Ver Anime"></a></li>';
        document.write(trtd);
        j++
    }
}
