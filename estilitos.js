...
function capanime(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<li><a class="titulo-rec" href="' + posturl + '">' + posttitle + '</a><div class="ver-encima"><a class="ver-anime" href=' + posturl + '>ver Dorama</a></div><a class="cuerpo-der" title="'+ posttitle +'" href="' + posturl + '"><img src="' + img[i] + '" width="270" height="112" border="0" alt="' + posttitle + '"/></a></li>';
        document.write(trtd);
        j++
    }
}
