...
function topanime(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
      ...
      numerar = numerar +1;
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<div class="loltopanime"><div class="loltopimg"><a title="'+ posttitle +'" href="' + posturl + '"><img src="' + img[i] + '" width="166" border="0" alt="' + posttitle + '"/></a></div><div class="topanimedt"><span>'+numerar+' </span><a href="' + posturl + '">' + posttitle + '<img src="http://cdn.jkanime.net/assets/images/like.png" style="vertical-align:middle;"/></a></div></div>';
        document.write(trtd);
        j++
    }
}
