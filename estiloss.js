...
function anime(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<div class="home_portada_bg"><a class="big_portada_title" href="' + posturl + '">' + posttitle + ' title="'+ posttitle +'"</a><a class="portada_big" href="' + posturl + '"><img src="' + img[i] + '" width="151" height="250" alt="' + posttitle + '"/></a></div>';
        document.write(trtd);
        j++
    }
}
