...
function topanime(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
      ...
      numerar = numerar +1;
        ...
        var daystr = day + ' ' + m + ' ' + y;
          var trtd = '<div class="loltopanime"><div class="loltopimg"><a title="'+ posttitle +'" href="' + posturl + '"><img src="' + img[i] + '" width="166" border="0" alt="' + posttitle + '"/></a></div><div class="topanimedt"><span>'+numerar+' </span><a href="' + posturl + '">' + posttitle + '<img src="http://cdn.jkanime.net/assets/images/like.png" style="vertical-align:middle;float:right;margin-right:-30px;"/></a></div></div>';
        document.write(trtd);
        j++
    }
}
...
function ultimosanimes(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
      ...
      var trtd = '<li><a href="' + posturl + '">' + posttitle + '<img src="http://www.doramasgratis.com/img/japon.jpg" style="vertical-align:middle;float:right;margin-right:0px;"/></a></li>';
        document.write(trtd);
        j++
    }
}

function ultimosanimess(json) {
    j = (showRandomImg) ? Math.floor((imgr.length + 1) * Math.random()) : 0;
    img = new Array();
    if (numposts2 <= json.feed.entry.length) {
        maxpost = numposts2
    ...
    for (var i = 0; i < maxpost; i++) {
      ...
      var trtd = '<li><a href="' + posturl + '">' + posttitle + '<img src="http://inkanime.com/imagenes/ncat.png" style="vertical-align:middle;float:right;margin-right:0px;"/></a></li>';
        document.write(trtd);
        j++
    }
}
...
function romancitas(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
        pcm = '<a href="' + posturl + '">' + pcm + ' comments</a>';
      var trtd = '<div class="lstsradd" style="margin: 0 0 4px 14px;padding: 3px;"><div class="snplblkn"></div><div class="animedt">' + posttitle + '</div><a class="tooltip" title="'+ posttitle +'" href="' + posturl + '"><div class="lstanmadd-lston"></div><img class="imglstsr" src="' + img[i] + '" width="165" border="0" alt="' + posttitle + '"/></a></div>';
        document.write(trtd);
        j++
    }
}
...
numero = 0;
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<div class="nivo-html-caption" id="htmlcaption-'+ numero +'"><a href="' + posturl + '"><strong style="width: 469px;height: 18px;line-height: 18px;font-size:18px;">' + posttitle + '</strong><img src="http://cdn.jkanime.net/assets/images/like.png" style="vertical-align:middle;float:left;margin-right:0px;"/></a></div>';
