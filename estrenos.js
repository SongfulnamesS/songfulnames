...
numero = 0;
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<div class="div.caption" id="htmlcaption-'+ numero +'"><a href="' + posturl + '"><strong style="width: 469px;height: 18px;line-height: 18px;font-size:18px;">' + posttitle + '</strong></a></div>';
