...
numero = 0;
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
      var trtd = '<a href="' + posturl + '"><div class="estreno-slider"><img src="' + img[i] + '" width="530" height="315" alt="' + posttitle + '" title="Ver Caitulo :'+ posttitle +'"/></div></a><span class="veranime"><a title="Ver '+ posttitle +'" href="' + posturl + '">Ver Ova</a></span>';
