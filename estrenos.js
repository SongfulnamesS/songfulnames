...
function showrecentposts1(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
      ...
      var trtd = '<div class="lolanime"><div class="lolimg"><a title="'+ posttitle +'" href="' + posturl + '"><img src="' + img[i] + '" width="166" border="0" alt="' + posttitle + '"/></a></div><div class="animedt"><a href="' + posturl + '">' + posttitle + '</a><span class="veranime"><a title="Ver '+ posttitle +'" href="' + posturl + '">Ver Pelicula</a></span></div></div>';
        document.write(trtd);
        j++
    }
}
